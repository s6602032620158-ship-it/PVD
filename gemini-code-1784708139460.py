...
# ==========================================
# 1. PAGE CONFIG & ULTRA-LUXE DARK CSS (Linear/Vercel Theme)
# ==========================================
st.set_page_config(
...
st.markdown(
    ...
    * {
    ...
    /* Main App Background - Obsidian Dark */
    .stApp {
        background: #07090E;
        color: #F8FAFC;
    }

    /* Top Brand Navigation Header (Vercel/Linear Style) */
    .brand-navbar {
...
# 🎨 SVG Diagram ปรับพิกัดใหม่หมด ไร้ปัญหาตัวอักษรทับกัน 100%
...
if S <= 0 or H_clay <= 0 or sigma0 <= 0:
    ...
    if err_msg:
        ...
        with img_col1:
            ...
            # Render SVG อย่างถูกวิธีด้วย st.html หมดปัญหาเรื่องโค้ดหลุดหรืออักษรทับ
        ...
        # Layout กราฟสไตล์ Dark Cyberpunk
        chart_layout = dict(
            font=dict(
