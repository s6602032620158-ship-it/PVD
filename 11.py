...
# Custom CSS targeting ONLY our custom HTML classes (Safe & Scoped)
st.markdown(
    """
    <style>
...
st.markdown(
    ...
    <div class="brand-navbar">
        <div>
            ...
            <span class="brand-badge" style="margin-left: 10px;">ENTERPRISE v4.3</span>
        </div>
...
# ==========================================
# 3. SIDEBAR CONTROLS (NATIVE STYLING)
# ==========================================
...
if S <= 0 or H_clay <= 0 or sigma0 <= 0:
    ...
    if err_msg:
        ...
        # 5.1 Native Streamlit Metrics (Zero Overlapping Guarantee)
        ...
        # 5.4 Intermediate Metrics Grid (Streamlit Native Metrics)
        with st.expander(
